...
export default function TrackingClient({ token }: { token: string }) {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // Moto AZUL de la marca (SVG inline, ícono "two_wheeler" de Material):
      // mismo render en todos los navegadores, con halo blanco para
      // destacar sobre el mapa.
      const icono = L.divIcon({
        html:
          '<div style="width:38px;height:38px;background:#fff;border-radius:50%;' +
          'display:flex;align-items:center;justify-content:center;' +
          'box-shadow:0 2px 6px rgba(0,0,0,.35);border:2px solid #004A94">' +
