          ...
          {items.map(o => {
            ...
            return (
              <button key={o.id} onClick={() => router.push(`/dashboard/servicios/${o.id}`)}
                className="rounded-xl bg-white p-3 text-left ring-1 ring-blue-400/40 shadow-sm transition-all duration-300 hover:bg-[#437EFF]/5 hover:ring-blue-400 hover:shadow-[0_0_30px_1px_rgba(0,255,117,0.30)]">
