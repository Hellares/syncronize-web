    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 lg:grid-cols-5">
        ...
        <div className="lg:col-span-3 space-y-3">
          ...
          <div className="grid gap-y-2.5 gap-x-[15px] grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 max-h-[calc(100vh-15rem)] overflow-y-auto rounded-xl bg-[#f0f0f0] p-3 content-start">
            {productos.map(p => (
