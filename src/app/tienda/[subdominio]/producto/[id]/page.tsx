    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-blue-700 text-white px-4 py-3">
        <div className="max-w-6xl mx-auto flex items-center gap-3">
          <Link href={`/tienda/${subdominio}`} className="flex items-center gap-2 hover:text-blue-200">
      ...
      <main className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="mt-4 bg-white rounded-lg border p-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <Link href={`/tienda/${subdominio}`} className="text-blue-600 hover:underline font-medium">
