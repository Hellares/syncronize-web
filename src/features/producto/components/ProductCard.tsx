...
export const PRODUCT_CARD_SHELL =
  'group relative flex w-full flex-col rounded-xl border border-gray-200 bg-white p-1 text-left shadow-[0_2px_8px_rgba(100,100,111,0.12)] transition-all duration-200 hover:-translate-y-1 hover:border-gray-300 hover:shadow-[0_12px_24px_rgba(0,74,148,0.18)] active:translate-y-0';
