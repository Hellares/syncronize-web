...
interface Props {
  /** El padre lo monta con `key={producto.id}`: así cada producto entra con
   *  estado limpio y el efecto no tiene que resetear nada a mano. */
  producto: Producto;
  empresaId?: string;
  onClose: () => void;
 ...
 */
export default function ProductoImagenesDialog({ producto, empresaId, onClose, onChanged }: Props) {
