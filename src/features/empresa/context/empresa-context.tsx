...
const DEFAULT_PERMISSIONS: EmpresaPermissions = {
  ...
  canViewClients: false, canManageClients: false, canCrearClientes: false,
  ...
  canManageOrders: false, canAsignarTecnico: false, canGestionarCostosOrden: false,
  canViewStatistics: false, canManageSettings: false,
