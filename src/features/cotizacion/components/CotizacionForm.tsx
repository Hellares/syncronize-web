...
const INPUT_STD = 'bg-zinc-100 text-zinc-700 font-sans ring-1 focus:ring-1 focus:ring-blue-400 outline-none transition-all duration-300 placeholder:text-zinc-500 placeholder:opacity-60 rounded-[6px] h-[30px] px-3 shadow-md focus:shadow-lg focus:shadow-blue-200';
// Variante para textarea (sin altura fija)
const INPUT_STD_TA = 'bg-zinc-100 text-zinc-700 font-sans ring-1 ring-zinc-400 focus:ring-1 focus:ring-blue-400 outline-none transition-all duration-300 placeholder:text-zinc-500 placeholder:opacity-60 rounded-[6px] px-3 py-2 shadow-md focus:shadow-lg focus:shadow-blue-200';
