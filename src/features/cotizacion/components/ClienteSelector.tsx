...
const inputClass = 'w-full bg-zinc-200 text-zinc-700 font-mono text-sm ring-1 ring-zinc-400 focus:ring-[1.5px] focus:ring-blue-400 outline-none transition-all duration-300 placeholder:text-zinc-500 placeholder:opacity-60 rounded-[6px] h-[30px] px-3 shadow-md focus:shadow-lg focus:shadow-blue-200';
