    ...
    <>
      ...
      {(() => {
        ...
        const BadgeCard = ({ badge, mobile }: { badge: typeof badges[0]; mobile?: boolean }) => (
          <div className={`bg-white shadow-md border border-gray-100 flex flex-col items-center text-center hover:shadow-lg transition-shadow cursor-pointer group ${mobile ? 'flex-shrink-0 w-[70px] p-1.5 rounded-md' : 'p-4 rounded-xl'}`}>
