    ...
    <>
      ...
      {(() => {
        ...
        const BadgeCard = ({ badge, mobile }: { badge: typeof badges[0]; mobile?: boolean }) => (
          ...
          <div className={`bg-gradient-to-t from-white/70 via-white/20 to-white/0 backdrop-blur-[2px] shadow-md flex flex-col items-center text-center hover:from-white/85 hover:via-white/40 hover:to-white/10 hover:shadow-lg transition-all cursor-pointer group ${mobile ? 'flex-shrink-0 w-[65px] p-1.5 rounded-[3px] shadow-none border-0' : 'p-4 rounded-md'}`}>
        ...
        return (
          ...
          <section className={`max-w-[910px] mx-auto px-0 md:px-6 relative z-10 ${hayBanners ? '-mt-14 md:-mt-[100px]' : '-mt-10'}`}>
            {/* Desktop: grid */}
      ...
      {/* Ofertas */}
      {ofertas.length > 0 && (
        <section className="max-w-7xl mx-auto px-0 md:px-6 mt-4 md:mt-8">
      ...
      {/* Main content */}
      <main id="productos-section" className="max-w-7xl mx-auto px-2 md:px-6 pt-3 pb-6 md:py-8 flex-1 w-full">
